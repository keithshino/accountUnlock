...
interface LoginPageProps {
    ...
    onGoogleLogin: () => void;
    onEmailSignUp: (email: string, pass: string) => void; // ★ 新規登録用の関数を追加
}
...
const LoginPage: React.FC<LoginPageProps> = ({ onEmailLogin, onGoogleLogin, onEmailSignUp }) => {
    ...
    const [authMode, setAuthMode] = useState<'login' | 'signup'>('login'); // ★ ログインか新規登録かを管理
                ...
                <div className="p-8">
                    {userType === 'client' ? (
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="mt-1 w-full p-3 border rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                                        required
                                    />
                                </div>
                                <div>
                            ...
                            <div className="mt-8">
                                {/* ★ ボタンの文字を切り替える */}
                                <button type="submit" className="w-full bg-blue-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-700 transition-transform transform hover:scale-105">
